...
IMPORTANT: Software piracy protection
========================================

LEKIN is protected from software piracy.  You are allowed to make as many
installations as you wish, provided that you are using the original floppy.
However, if you attempt to copy this floppy, the copy will not work.

If the original floppy gets corrupted, we will be happy to provide you with
a replacement.

The above does not apply to the Demo version.  You are free to make as many
copies of it as you need.
...
To compare various schedules,
    ...
    2. Select Tools->Objectives to generate the graph comparing
       the schedules generated.
    3. Clicking on a schedule name on the Objectives graph makes this
       schedule "current".  The Sequence and the Gantt Chart windows
       always show the "current" schedule.
...
- the chief designer/programmer -- Andrew Feldman (andrew@ieor.columbia.edu)
